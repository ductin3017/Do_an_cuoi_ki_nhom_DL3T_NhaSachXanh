...
.dh tr:nth-child(1){
    ...
    <body>
        ...
        <div class="noidung">
            <div class="homepage" >
                  <h2 style="margin-left: 550px; font-family: Nunito; font-weight:bold; color: #004225">CHI TIẾT ĐƠN HÀNG</h2>
                  <table class="dh" border='1' WIDTH='100%' style=" margin-top: 10px; margin-left: 200px;margin-bottom: 100px;"> 
                    <tr>
                    <TD style=" background-color:#90CF8E; width: 100px;height:40px;" ><b>MÃ ĐH</b></TD>
                    <TD style=" background-color:#90CF8E; width: 150px;" ><b>MÃ CTĐH</b></TD>
                    <TD style=" background-color:#90CF8E; width: 300px;"><b>TÊN SÁCH</b></TD>
                    <TD style="background-color:#90CF8E; "><b>SÔ LƯỢNG</TD>
                    <TD style="background-color:#90CF8E; s"><b>THÀNH TIỀN</b></TD>
                    </tr>
