        ...
        <div class="noidung">
            <div class="homepage" >
                  ...
                  <table class="dh" border='1' WIDTH='100%' style=" margin-top: 10px;"> 
                    ...
                    <TD style=" background-color:#90CF8E;width: 150px;"><b>TÊN KH</b></TD>
                    <TD style=" background-color:#90CF8E;width: 200px;"><b>ĐỊA CHỈ</b></TD>
                    <TD style=" background-color:#90CF8E;width: 100px;"><b>SDT</b></TD>
                    <TD style=" background-color:#90CF8E;width: 160px;" ><b>EMAIL</b></TD>
                    <TD style=" background-color:#90CF8E;width: 100px;"><b>TỔNG</b></TD>
                    <TD style=" background-color:#90CF8E;text-align:center;" ><b>GỬI</b></TD>
                    <TD style=" background-color:#90CF8E;width: 100px;"><b>NGÀY ĐẶT</b></TD>
                    <TD style=" background-color:#90CF8E;width: 150px;" ><b>NGƯỜI GIAO</b></TD>
                    <TD style=" background-color:#90CF8E;width: 100px;"><b>TT</b></TD>
                    <TD style=" background-color:#90CF8E;width: 150px;"><b>SỬA TT</b></TD>
                    <TD style=" background-color:#90CF8E;width:100px;"><b>LƯU</b></TD>
                    <TD style=" background-color:#90CF8E;width:100px;"><b>IN </b></TD>
                    <TD style=" background-color:#90CF8E;width:100px;"><b></b></TD>
                    </tr>
                    ...
                    $result = mysqli_query($conn,$sql);
                            ...
                            if($row['tinhtrang'] == "Gói hàng"){
                                ...
                                echo'    <select name="trangthai" style="width: 210px; height: 30px;">
                                             ...
                                             <td style="text-align: center;"><a href="luunvgh.php?"><input type="submit" value="Lưu"  style=" width: 40px;height: 30px;background: #004225;border:none;margin-top: 10px;color: #FAFAFA;"></a></td>
                                             <td style="text-align: center;"><a style="color: #004225;" href="inhd.php?tenkh='.$row['tenkh'].'&dc='.$row['diachikh'].'&sdt='.$row['sdtkh'].'&em='.$row['emailkh'].'&tnd='.$row['tennv'].'&mdh='.$row['madh'].'" style="text-decoration:none;">In</a></td>
                                             <td ><a style="color: #004225;" href="chitiet.php?mdh='.$madd.'">Chi tiết</a></td>
                                            </form>
                                            </tr>';
                            }
                            }
