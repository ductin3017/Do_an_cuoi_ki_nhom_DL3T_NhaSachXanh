        ...
        <div class="noidung">
            ...
            <div class="homepage">
                ...
                if(isset($_SESSION['status']))
                    {
                    echo '
                <h2 style="margin-left: 320px;margin-top: 20px; color: #004225;font-family:Nunito;">THÔNG TIN CÁ NHÂN</h2>
                <form method="POST" action="xuliupdatethongtinnd.php" style="margin-left: 250px; width: 500px; margin-top: 30px; font-family:Nunito; ">
                    <fieldset style="height:610px; border:1px solid #0b243b"> 
                    <h5 style="padding-left:12px; padding-top:10px; padding-bottom:5px; font-family:Nunito; font-style: italic;">Tên người dùng</h5>
                    ...
                    <br><h5 style="padding-left:12px; padding-top:10px; padding-bottom:5px; font-family:Nunito; font-style: italic;">Địa chỉ</h5>
                    ...
                    </br><h5 style="padding-left:12px; padding-top:10px; padding-bottom:5px; font-family:Nunito; font-style: italic;">Số điện thoại</h5>
                    ...
                    <h5 style="padding-left:12px; padding-top:10px; padding-bottom:5px; font-family:Nunito; font-style: italic;">Email</h5>
                    ...
                    <h5 style="padding-left:12px; padding-top:10px; padding-bottom:5px; font-family:Nunito; font-style: italic;">Ngày sinh</h5>
                    <input class="tx" type="date" id="s" name="ns" value="'.$_SESSION['ns'].'" placeholder="Ngày sinh" style="height:30px; margin-left:15px"/></br></br>
                    <h5 style="padding-left:12px; padding-top:10px; padding-bottom:5px; font-family:Nunito; font-style: italic;">Giới tính</h5>
