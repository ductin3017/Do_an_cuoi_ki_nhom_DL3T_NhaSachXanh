                    ...
                    <form action="xulictsachgh.php" method="POST">
                        ...
                        ?>
                                <tr><td colspan="7"><hr style="border:1px Solid #0b243b;"></tr>
                                                            ...
                                                            <tr>
                                                                 <p style="font-family:Nunito; color: gray; font-size:18px"> Phí giao hàng:10000VNĐ </p>
                                                            <td colspan="6" align="right">
                                                            <h4 style="color:red;font-family:Nunito;">Tổng tiền:</h4>

                                                            </td>
                                                            <td> <h4 style="color:red;font-family:Nunito;"><?php echo $tot; ?>VNĐ </h4></td>
                                                            </tr>
                                                            <tr><td colspan="7"><hr style="border:1px Solid #0b243b; margin-bottom: 20px;"></tr>
                </TABLE>
                        
                        <?php
                    echo    '<a href="csthongtin.php?tong='.$tot.'" style="text-decoration: none; font-size:24px; color:#f46523"><input style="width: 140px;height: 35px;background: #004225;border:none;margin-left: 355px;margin-top: 10px;border-radius: 15px;color: #FAFAFA;" type="button" value="Đặt hàng"></a>'
                                ?>
                         <?php
                    echo    '<a href="guitang.php?tong='.$tot.'" style="text-decoration: none; font-size:24px; color:#f46523"><input style="width: 140px;height: 35px;background: #004225;border:none;margin-left: 355px;margin-top: 10px;border-radius: 15px;color: #FAFAFA;" type="button" value="Gửi tặng"></a>'
                                ?>
