...
<html>
                        ...
                        if(isset($_POST['ts']) and isset($_POST['sl']) and isset($_POST['id']) and isset($_POST['gia']))
	{
                    ...
                    echo '
                <h2 style="margin-left: 35%;margin-top: 10px; color: #004225; font-family:Nunito">THÔNG TIN NGƯỜI NHẬN</h2>
                <form method="POST" style="margin-left: 230px; width: 500px; margin-top: 30px; font-family: Playfair Display ">
                    ...
                    <h4 style="padding-left:20px; padding-top:20px;padding-bottom:10px; font-family:Nunito">Tên người nhận</h4>
                    ...
                    <h4 style="padding-left:20px; padding-top:20px;padding-bottom:10px; font-family:Nunito">Địa chỉ người nhận</h4>
                    ...
                    <h4 style="padding-left:20px; padding-top:20px;padding-bottom:10px; font-family:Nunito">SĐT người nhận</h4>
                    ...
                    <h4 style="padding-left:20px; padding-top:20px;padding-bottom:10px; font-family:Nunito">Email người nhận</h4>
