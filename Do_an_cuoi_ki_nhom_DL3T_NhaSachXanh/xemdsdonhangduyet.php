...
.dh tr:nth-child(1){
    ...
    <body>
        ...
        <div class="noidung">
            <div class="homepage" >
                  <h2 style="margin-left: 500px; font-family: Nunito; font-weight:bold; color: #004225">TẤT CẢ ĐƠN HÀNG</h2>
    ...
    border-radius: 15px;
    color: #FAFAFA;
    font-size:18px;" type="button" value="Đơn hàng hoàn tất"></a>
    ...
    border-radius: 15px;
    color: #FAFAFA;
    font-size:18px;" type="button" value="Đơn hàng không nhận"></a>
                  <table class="dh" border='1' WIDTH='100%' style=" margin-top: 10px;"> 
                    <tr>
                    <TD style=" background-color:#90CF8E; width: 20px;height:50px;" ><b>MÃ ĐH</b></TD>
                    <TD style=" background-color:#90CF8E; width: 150px;"><b>TÊN KHÁCH HÀNG</b></TD>
                    <TD style=" background-color:#90CF8E; width: 150px;"><b>ĐỊA CHỈ</b></TD>
                    <TD style=" background-color:#90CF8E; width: 100px;"><b>SĐT</b></TD>
                    <TD style=" background-color:#90CF8E; width: 200px;" ><b>EMAIL</b></TD>
                    <TD style=" background-color:#90CF8E; width: 90px;"><b>TỔNG </b></TD>
                    <TD style="background-color:#90CF8E; width: 70px;"><b>GỬI </b></TD>
                    <TD style="background-color:#90CF8E; width: 90px;"><b>NGÀY ĐẶT</b></TD>
                    <TD style="background-color:#90CF8E; width: 150px;" ><b>NGƯỜI GIAO</b></TD>
                    <TD style="background-color:#90CF8E; "><b>TRẠNG THÁI</b></TD>
                    <TD style="background-color:#90CF8E; width: 50px;"><b></b></TD>
                    </tr>
