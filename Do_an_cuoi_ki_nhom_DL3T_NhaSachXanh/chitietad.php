...
.dh tr:nth-child(1){
    ...
    <body>
        ...
        <div class="noidung">
            <div class="homepage" >
                  <h2 style="margin-left: 500px; font-family: Nunito; font-weight:bold; color: #004225">CHI TIẾT ĐƠN HÀNG</h2>
                  <table class="dh" border='1' WIDTH='100%' style=" margin-top: 10px; margin-left: 200px;margin-bottom: 100px;"> 
                    <tr>
                    <TD style="color:black; background-color:#90CF8E; width:80px;height:40px;" ><b>MÃ ĐH</b></TD>
                    <TD style="color:black; background-color:#90CF8E; width: 100px;" ><b>MÃ CTĐH</b></TD>
                    <TD style="color:black; background-color:#90CF8E; width: 280px;"><b>TÊN SÁCH ĐẶT</b></TD>
                    <TD style="color:black; background-color:#90CF8E;"><b>SỐ LƯỢNG</b></TD>
                    <TD style="color:black; background-color:#90CF8E;"><b>THÀNH TIỀN</b></TD>
                    </tr>
