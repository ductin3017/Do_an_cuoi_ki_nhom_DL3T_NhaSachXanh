                    ...
                    <form action="xulictsachgh.php" method="POST">
                        ...
                        ?>
                                <tr><td colspan="7"><hr style="border:1px Solid #0b243b;"></tr>
                                                            ...
                                                            <h4 style="color:red;font-family:Nunito; font-size:17px;">Tổng tiền:</h4>

                                                            </td>
                                                            <td> <h3 style="font-family:Nunito; font-size:17px; color:red;"><?php echo $tot; ?> VNĐ</h3></td>
                                                            </tr>
                                                            <tr><td colspan="7"><hr style="border:1px Solid #0b243b; margin-bottom: 20px;"></tr>
                </TABLE>
                        <input type="submit" value="Lưu"  style="margin-left: 355px; width: 140px;height: 35px;background: #004225;border:none;margin-top: 10px;border-radius: 15px;color: #FAFAFA;"> </br>
                    </form>      
                    <a href="sach.php"><input type="submit" value="Thêm sách"  style="margin-left: 355px; width: 140px;height: 35px;background:#004225;border:none;margin-top: 10px;border-radius: 15px;color: #FAFAFA;"> </br></a>
                    <a href="dh.php"><input type="submit" value="Đặt hàng"  style="margin-left: 355px; width: 140px;height: 35px;background: #004225;border:none;margin-top: 10px;border-radius: 15px;color: #FAFAFA;"> </br></a>
            </div>
            </div>
        </div>
        <div>
