    ...
    <body>
        ...
        <div class="noidung">
            ...
            <div class="hhomepage">
                        ...
                        echo '<h2 style="color:green; font-family:Nunito; margin-top:20px; font-family:Nunito;" class="spnoibat">Kết quả trả về </h2>';
                                $count=0;
     ...
     echo'
                    ...
                    <p style="text-align:center; font-family: Nunito; font-weight:bold; color:red">'.$row['gia'].'₫</p>
