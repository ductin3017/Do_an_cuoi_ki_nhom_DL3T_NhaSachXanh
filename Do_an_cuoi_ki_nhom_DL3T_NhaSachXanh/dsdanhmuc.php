...
.dh tr:nth-child(1){
    ...
    <body>
        ...
        <div class="noidung">
            <div class="homepage">
                  <h2 style="font-family: Nunito; font-weight:bold; margin-left: 500px; color: #004225">TẤT CẢ DANH MỤC</h2>
    ...
    font-size:22px;" type="button" value="Thêm"></a>
                  <table class="dh" border='1' WIDTH='100%' style="margin-left: 250px;"> 
                    <tr>
                    <TD style="color:black; height:40px; background-color:#90CF8E;" WIDTH='5%'><b>MÃ DANH MỤC</b></TD>
                    <TD style="color:black; background-color:#90CF8E;" WIDTH='5%'><b>TÊN DANH MỤC</b></TD>
                    <TD style="color:black; background-color:#90CF8E;" WIDTH='5%'><b></b></TD>
                    <TD style="color:black; background-color:#90CF8E;" WIDTH='5%'><b></b></TD>
                    </tr>
