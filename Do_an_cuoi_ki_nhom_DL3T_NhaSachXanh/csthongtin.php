...
<html>
                        ...
                        if(isset($_POST['ts']) and isset($_POST['sl']) and isset($_POST['id']) and isset($_POST['gia']))
	{
                    ...
                    echo '
                <h2 style="margin-left: 350px;margin-top: 20px; color: #004225; font-family:Nunito">THÔNG TIN CÁ NHÂN</h2>
                <form method="POST" style="margin-left: 280px; width: 500px; margin-top: 30px">
                    <fieldset style="height:430px; border:1px solid #0b243b"> 
                    <h5 style="padding-left:30px; padding-top:15px; padding-bottom:7px; font-family:Nunito">Tên người dùng</h5>
                    ...
                    <h5 style="padding-left:30px;  font-family:Nunito;">Địa chỉ</h5>
                    ...
                    <h5 style="padding-left:30px;  font-family:Nunito;">Số điện thoại</h5>
                    ...
                    <h5 style="padding-left:30px;  font-family:Nunito;">Email</h5>
