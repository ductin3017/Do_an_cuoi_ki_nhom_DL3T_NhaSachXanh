...
.curren-page{
    ...
    <body>
        <?php
            ...
            echo '<h2 class="spnoibat" style=" font-family: Nunito; font-weight:bold; color:#004225; margin-bottom:50px""> TẤT CẢ SÁCH</h2>';
...
//                '<TR><TD>'.$row['hinhanh'].'</TD><TD>'.$row['tensach'].'</TD></TR>';     
     ...
     echo'
                    ...
                    <p style="text-align:center; color:black; font-size:18px; font-weight:bold;   font-family: Nunito;">'.$row['tensach'].'</p>
                    <p style="border:1px solid #D8D8D8"></p>
                 
                   <p style="text-align:center; font-family: Nunito; margin-bottom:5px;font-weight:bold; color:#004225">'.$row['gia'].'₫</p>
                    <p style="text-align:center; font-size:14px;  color:black; font-family: Nunito;  text-decoration: line-through;">'.$row['giagoc'].'₫</p>
