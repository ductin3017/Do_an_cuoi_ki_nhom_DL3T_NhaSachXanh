    ...
    <body>
        ...
        <div class="noidung">
            ...
            <div class="hhomepage">
                        ...
                        echo '<h2 style="color:green; margin-left:150px;margin-top:20px; font-family:Nunito" class="spnoibat">Kết quả trả về với từ khóa: '.$search.'</h2>';
                                $count=0;
     ...
     echo'
                    ...
                    echo'
                            ...
                            echo '<h2 style="color:green; font-family:Nunito; margin-top:30px; " class="kcokq">Không có kết quả trả về với từ khóa: '.$search.'</h2>';
                        }
                        ?>
