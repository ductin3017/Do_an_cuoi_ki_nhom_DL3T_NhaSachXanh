        ...
        <div class="noidung">
            ...
            <div class="homepage">
                ...
                if(isset($_SESSION['status']))
                    {
                    echo '
                <h2 style="margin-left: 340px;margin-top: 20px; color: #004225;padding-left:12px; padding-top:10px;  font-family:Nunito;">ĐỔI MẬT KHẨU</h2>
                <form method="POST" action="xulidoimk.php" style="margin-left: 280px; width: 500px; margin-top: 20px">
                    ...
                    <h4 style="margin-top: 20px; color: #004225; padding-top:10px; padding-bottom:5px; font-family:Nunito;" >Nhập mật khẩu mới</h4>
                    <input class="tx" id="mkm" type="password"  name="mkm" value="" placeholder="Nhập mật khẩu mới" style="width:90%;height:30px;" /></br>
                    </br><h4 style="margin-top: 20px; color: #004225; padding-top:10px; padding-bottom:5px; font-family:Nunito;">Nhập lại mật khẩu mới</h4>
