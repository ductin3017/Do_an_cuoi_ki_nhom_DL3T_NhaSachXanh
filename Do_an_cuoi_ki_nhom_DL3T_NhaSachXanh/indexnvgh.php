  ...
  <div class="az-header" style="background-color:#E4FDE1;  height:70px;">
    <div class="container" style="background-color:#E4FDE1; height:70px; ">
      <div class="az-header-left">
        <a href=""><img src="img/blog/logo.png" width="250" height="me-auto"></a>
      ...
      <div class="az-header-right">
        ...
        <div class="dropdown az-profile-menu" style="width:50px">
          <a href="" class="az-img-user"><img src="./img/gai1.jpg" alt=""></a>
          <div class="dropdown-menu">
    ...
    <div class="container">
      <div class="az-content-body">
        <div class="az-dashboard-one-title">
          <div>
            <marquee style="width:500px; font-family: 'Nunito'; color: #3A5A40; font-weight: bold; font-style:italic;font-size:20px;"> Xin chào, Nhân viên giao hàng!</marquee>
