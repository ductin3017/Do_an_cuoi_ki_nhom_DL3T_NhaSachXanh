...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 23, 2023 at 03:24 PM
...
(215, 39, 23, '2023-12-23', 'Giao hàng thành công', 1, 346000);
...
CREATE TABLE `guitang` (
  ...
  `diachigt` varchar(100) NOT NULL,
  `sdtgt` text NOT NULL,
  `emailgt` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_unicode_ci;

--
-- Dumping data for table `guitang`
--
...
(16, 187, '', '', '', ''),
(18, 215, 'Thái Phạm', 'HCM', '0099228833', 'thaipham33@email.com');
...
(23, 'Khách Hàng A', 'khachhang1', 'khachhang1', 'Thủ Đức', '0889900220', 'khachhang1@khachhang.com', '2000-10-10', '', '2023-12-23'),
(24, 'Khách Hàng B', 'khachhang2', 'khachhang2', 'Gò Vấp', '0220099990', 'khachhang2@khachhang.com', '2002-09-09', '', '2023-12-23');
...
(1, 'Thúy Lam', 'admin', 'admin', 'Bình Dương', '0987654321', 'admin@admin.com', '2003-01-01', 'Nữ', '2023-12-23', 'admin', 'Active'),
(38, 'Hoàng Thái', 'nvkho1', 'nvkho1', 'TPHCM', '0987123456', 'nvkho1@nvkho.com', '2003-01-01', 'Nam', '2023-12-23', 'nvkho', 'Active'),
(39, 'Đức Tín', 'nvgh1', 'nvgh1', 'T', '0981234567', 'nvgh1@nvgh.com', '2003-02-02', 'Nam', '2023-12-23', 'nvgiaohang', 'Active'),
(40, 'Huỳnh Đức', 'nvkho2', 'nvkho2', 'HCM', '0998877660', 'nvkho2@nvkho.com', '2003-03-03', 'Nam', '2023-12-23', 'nvkho', 'Active'),
(41, 'A Toàn', 'nvgh2', 'nvgh2', 'HCM City', '0111222333', 'nvgh2@nvgh.com', '2003-04-04', 'Nam', '2023-12-23', 'nvgiaohang', 'Active');
...
CREATE TABLE `nhaxuatban` (
  ...
  `sdtnxb` varchar(10) NOT NULL,
  `emailnxb` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_unicode_ci;
...
CREATE TABLE `review_table` (
  ...
  `user_review` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `tblcontactus` (
  ...
  `AdminRemark` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
ALTER TABLE `chitietdonhang`
  MODIFY `mactdh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=236;
...
--
ALTER TABLE `donhang`
  MODIFY `madh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=216;

--
-- AUTO_INCREMENT for table `guitang`
--
ALTER TABLE `guitang`
  MODIFY `maguitang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `phieunhap`
  MODIFY `manhap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
