...
<body>
    ...
    <div class="noidung">
        <div class="homepage">
            <h2 style="margin-left: 500px; font-family: Nunito; font-weight:bold; color: #004225">TẤT CẢ PHIẾU NHẬP</h2>
            <table class="dh" border='1' WIDTH='100%' style="margin-left: 80px;">
                <tr>
                    <TD style="background-color:#90CF8E; width: 90px;height:40px;"><b>MÃ PHIẾU </b></TD>
                    <TD style=" background-color:#90CF8E; width: 200px;"><b>TÊN NGƯỜI NHẬN</b></TD>
                    <TD style=" background-color:#90CF8E; width: 400px;"><b>TÊN SÁCH</b></TD>
                    <TD style="background-color:#90CF8E; width: 150px;"><b>SỐ LƯỢNG NHẬP</b></TD>
                    <TD style=" background-color:#90CF8E; width: 150px;"><b>NGÀY NHẬP</b></TD>
                </tr>
