...
.dh tr:nth-child(1){
    ...
    <body>
        ...
        <div class="noidung">
            <div class="homepage" >
                <br>
                <h2 style="margin-left: 350px; font-family: Nunito; font-weight:bold; color: #004225">DANH SÁCH ĐƠN HÀNG KHÔNG NHẬN</h2>
                  ...
                  <table class="dh" border='1' WIDTH='100%' style=" margin-top: 10px;"> 
                    ...
                    <TD style="background-color:#90CF8E;  width: 50px;text-align:center;" ><b>GỬI</b></TD>
                    <TD style="background-color:#90CF8E; width: 100px"><b>NGÀY ĐẶT</b></TD>
                    <TD style="background-color:#90CF8E;" ><b>NGƯỜI GIAO</b></TD>
                    <TD style="background-color:#90CF8E;"><b>TT</b></TD>
